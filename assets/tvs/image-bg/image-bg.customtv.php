<style>
	...
	.image-bg img{max-height:100%;}
	.mimipic_thumb{position:absolute; top:0;left:0;width:30px;height:30px; padding:2px;z-index:22;cursor:pointer;}
	.minipic_show{width:128px; height:128px; position:absolute;top:-128px; background:white; padding:5px; z-index:99;    box-shadow: 0 0.2rem 2rem rgb(0 0 0 / 10%); display:none;}
...
<div class="image-bg">
	...
	<input class="form-control" type="button" value="Вставить" onclick="BrowseServer('tv<?=$field_id?>')">
</div>
<script>
